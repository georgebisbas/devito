...
float ** * jacobi_3d_all(int timesteps, int nrows, int ncols, float ** * grid, int omp_opt) {
  int t = 0;
  int xi = 0;
  int yi = 0;
...
float *** jacobi_3d_all_SKEW(int timesteps, int nrows, int ncols, float ** * grid, int omp_opt) {
  int t = 0;
  int xi = 0;
  int yi = 0;
